...
const (
	// PaymentStatus — status transaksi di sistem internal
	...
	// PaymentType — jenis produk yang dibeli
	PaymentTypeMembership PaymentType = "membership"

	// ChangeType — jenis perubahan membership akibat transaksi ini
	...
	// CancelReason — alasan pembatalan oleh user
...
type TransactionResponse struct {
	...
	MerchantReff string `json:"merchant_ref"`
